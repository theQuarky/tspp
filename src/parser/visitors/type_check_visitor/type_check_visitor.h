...
class TypeCheckVisitor {
 public:
  ...
  std::shared_ptr<ResolvedType> visitFuncDecl(
      const nodes::FunctionDeclNode *node);
  std::shared_ptr<ResolvedType> visitGenericFuncDecl(
      const nodes::GenericFunctionDeclNode *node);
  std::shared_ptr<ResolvedType> visitClassDecl(
      const nodes::ClassDeclNode *node);
  std::shared_ptr<ResolvedType> visitGenericClassDecl(
      const nodes::GenericClassDeclNode *node);
  std::shared_ptr<ResolvedType> visitConstructorDecl(
      const nodes::ConstructorDeclNode *node);
  std::shared_ptr<ResolvedType> visitMethodDecl(
      const nodes::MethodDeclNode *node);
  std::shared_ptr<ResolvedType> visitFieldDecl(
      const nodes::FieldDeclNode *node);
  std::shared_ptr<ResolvedType> visitPropertyDecl(
      const nodes::PropertyDeclNode *node);
  std::shared_ptr<ResolvedType> visitEnumDecl(const nodes::EnumDeclNode *node);
  std::shared_ptr<ResolvedType> visitEnumMember(
      const nodes::EnumMemberNode *node);
  std::shared_ptr<ResolvedType> visitInterfaceDecl(
      const nodes::InterfaceDeclNode *node);
  std::shared_ptr<ResolvedType> visitGenericInterfaceDecl(
      const nodes::GenericInterfaceDeclNode *node);
  std::shared_ptr<ResolvedType> visitMethodSignature(
      const nodes::MethodSignatureNode *node);
  std::shared_ptr<ResolvedType> visitPropertySignature(
      const nodes::PropertySignatureNode *node);
  std::shared_ptr<ResolvedType> visitNamespaceDecl(
      const nodes::NamespaceDeclNode *node);
  std::shared_ptr<ResolvedType> visitTypedefDecl(
      const nodes::TypedefDeclNode *node);
  std::shared_ptr<ResolvedType> visitParameter(
      const nodes::ParameterNode *node);
  std::shared_ptr<ResolvedType> visitAttribute(
      const nodes::AttributeNode *node);

  // Statement visitors
  std::shared_ptr<ResolvedType> visitStmt(const nodes::StatementNode *node);
  std::shared_ptr<ResolvedType> visitDeclarationStmt(
      const nodes::DeclarationStmtNode *node);
  std::shared_ptr<ResolvedType> visitExprStmt(
  ...
  std::shared_ptr<ResolvedType> visitWhileStmt(
      const nodes::WhileStmtNode *node);
  std::shared_ptr<ResolvedType> visitDoWhileStmt(
      const nodes::DoWhileStmtNode *node);
  std::shared_ptr<ResolvedType> visitForStmt(const nodes::ForStmtNode *node);
  std::shared_ptr<ResolvedType> visitForOfStmt(
      const nodes::ForOfStmtNode *node);
  std::shared_ptr<ResolvedType> visitBreakStmt(
      const nodes::BreakStmtNode *node);
  std::shared_ptr<ResolvedType> visitContinueStmt(
      const nodes::ContinueStmtNode *node);
  std::shared_ptr<ResolvedType> visitReturnStmt(
      const nodes::ReturnStmtNode *node);
  std::shared_ptr<ResolvedType> visitTryStmt(const nodes::TryStmtNode *node);
  std::shared_ptr<ResolvedType> visitThrowStmt(
      const nodes::ThrowStmtNode *node);
  std::shared_ptr<ResolvedType> visitSwitchStmt(
      const nodes::SwitchStmtNode *node);
  std::shared_ptr<ResolvedType> visitAssemblyStmt(
      const nodes::AssemblyStmtNode *node);
  std::shared_ptr<ResolvedType> visitLabeledStmt(
      const nodes::LabeledStatementNode *node);

  // Expression visitors
  std::shared_ptr<ResolvedType> visitExpr(const nodes::ExpressionNode *node);
  std::shared_ptr<ResolvedType> visitBinaryExpr(
      const nodes::BinaryExpressionNode *node);
  std::shared_ptr<ResolvedType> visitUnaryExpr(
      const nodes::UnaryExpressionNode *node);
  std::shared_ptr<ResolvedType> visitLiteralExpr(
      const nodes::LiteralExpressionNode *node);
  std::shared_ptr<ResolvedType> visitIdentifierExpr(
      const nodes::IdentifierExpressionNode *node);
  std::shared_ptr<ResolvedType> visitCallExpr(
      const nodes::CallExpressionNode *node);
  std::shared_ptr<ResolvedType> visitAssignmentExpr(
      const nodes::AssignmentExpressionNode *node);
  std::shared_ptr<ResolvedType> visitMemberExpr(
      const nodes::MemberExpressionNode *node);
  std::shared_ptr<ResolvedType> visitIndexExpr(
      const nodes::IndexExpressionNode *node);
  std::shared_ptr<ResolvedType> visitNewExpr(
      const nodes::NewExpressionNode *node);
  std::shared_ptr<ResolvedType> visitCastExpr(
      const nodes::CastExpressionNode *node);
  std::shared_ptr<ResolvedType> visitArrayLiteral(
      const nodes::ArrayLiteralNode *node);
  std::shared_ptr<ResolvedType> visitConditionalExpr(
      const nodes::ConditionalExpressionNode *node);
  std::shared_ptr<ResolvedType> visitThisExpr(
      const nodes::ThisExpressionNode *node);
  std::shared_ptr<ResolvedType> visitCompileTimeExpr(
      const nodes::CompileTimeExpressionNode *node);
  std::shared_ptr<ResolvedType> visitTemplateSpecialization(
      const nodes::TemplateSpecializationNode *node);
  std::shared_ptr<ResolvedType> visitPointerExpr(
      const nodes::PointerExpressionNode *node);
  std::shared_ptr<ResolvedType> visitFunctionExpr(
      const nodes::FunctionExpressionNode *node);

  // Type visitors
  std::shared_ptr<ResolvedType> visitType(const nodes::TypeNode *node);
  std::shared_ptr<ResolvedType> visitPrimitiveType(
      const nodes::PrimitiveTypeNode *node);
  std::shared_ptr<ResolvedType> visitNamedType(
      const nodes::NamedTypeNode *node);
  std::shared_ptr<ResolvedType> visitQualifiedType(
      const nodes::QualifiedTypeNode *node);
  std::shared_ptr<ResolvedType> visitArrayType(
      const nodes::ArrayTypeNode *node);
  std::shared_ptr<ResolvedType> visitPointerType(
      const nodes::PointerTypeNode *node);
  std::shared_ptr<ResolvedType> visitReferenceType(
      const nodes::ReferenceTypeNode *node);
  std::shared_ptr<ResolvedType> visitFunctionType(
      const nodes::FunctionTypeNode *node);
  std::shared_ptr<ResolvedType> visitTemplateType(
      const nodes::TemplateTypeNode *node);
  std::shared_ptr<ResolvedType> visitSmartPointerType(
      const nodes::SmartPointerTypeNode *node);
  std::shared_ptr<ResolvedType> visitUnionType(
      const nodes::UnionTypeNode *node);
  std::shared_ptr<ResolvedType> visitGenericParam(
      const nodes::GenericParamNode *node);
  std::shared_ptr<ResolvedType> visitBuiltinConstraint(
 ...
 private:
  ...
  std::shared_ptr<ResolvedType> checkBinaryOp(
  ...
  std::shared_ptr<ResolvedType> checkUnaryOp(
