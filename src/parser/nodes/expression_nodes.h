...
class ExpressionNode : public BaseNode {
 public:
  ...
  tokens::TokenType getExpressionType() const {
...
class UnaryExpressionNode : public ExpressionNode {
 public:
  ...
  ExpressionPtr getOperand() const {
    return operand_;
  }
  bool isPrefix() const {
    return isPrefix_;
...
class ConditionalExpressionNode : public ExpressionNode {
 public:
  ...
  ExpressionPtr getTrueExpression() const {
    return trueExpr_;
  }
  ExpressionPtr getFalseExpression() const {
    return falseExpr_;
  }
...
class MemberExpressionNode : public ExpressionNode {
 public:
  MemberExpressionNode(const core::SourceLocation &loc, ExpressionPtr object,
      ...
      : ExpressionNode(
            loc, isPointer ? tokens::TokenType::AT : tokens::TokenType::DOT),
        object_(std::move(object)),
        member_(std::move(member)),
        isPointer_(isPointer) {}

  ExpressionPtr getObject() const {
    return object_;
  }
...
class AttributeNode : public BaseNode {
 public:
  ...
  ExpressionPtr getArgument() const {
    return argument_;
  }
