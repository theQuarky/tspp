...
class ResolvedType {
 public:
  ...
  static ResolvedType IntLiteralZero();
  ...
  std::shared_ptr<ResolvedType> getElementType() const {
    return elementType_;
  }
  std::shared_ptr<ResolvedType> getPointeeType() const {
    return pointeeType_;
  }
  std::shared_ptr<ResolvedType> getReturnType() const {
    return returnType_;
  }
  const std::vector<std::shared_ptr<ResolvedType>> &getParameterTypes() const {
    return paramTypes_;
  }
  SmartKind getSmartKind() const {
    return smartKind_;
  }
  std::shared_ptr<ResolvedType> getLeftType() const {
    return leftType_;
  }
  std::shared_ptr<ResolvedType> getRightType() const {
    return rightType_;
  }
 ...
 private:
  ...
  bool isLiteralZero_ = false;  // [TSPP+] Tracks whether int is literal zero
};
